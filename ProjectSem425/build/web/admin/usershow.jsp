<%-- 
    Document   : usershow
    Created on : Sep 13, 2023, 12:09:44 AM
    Author     : Admin
--%>
                                ...
                                <div class="table-responsive">
                                    <div class="form-group d-flex">
                                        ...
                                        <div class="col-md-9 col-xl-8">
                                            <img class="img-profile rounded-circle" style="height: 100px;" src="img/undraw_profile.svg">
                                        </div>
                                    </div>
                                    <div class="form-group d-flex">
                                    ...
                                    <div class="form-group d-flex">
                                        <label for="address" class="col-md-3 text-md-right ">Level</label>
                                        <div class="col-md-9 col-xl-8">
                                            <p>Hà Nội</p>
                                        </div>
                                    </div>
