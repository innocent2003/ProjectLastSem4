<%-- 
    Document   : useredit
    Created on : Sep 13, 2023, 12:10:12 AM
    Author     : Admin
--%>
                                    ...
                                    <div class="table-responsive">
                                        <div class="form-group d-flex">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input type="file" aria-describedby="basic-addon1" />
                                            </div>
                                        </div>
                                        <div class="form-group d-flex">
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input type="email" class="form-control rounded" placeholder="name@gmail.com" aria-label="email" aria-describedby="basic-addon1" />
                                            </div>
                                        </div>
                                        <div class="form-group d-flex">
